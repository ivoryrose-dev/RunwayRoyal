...
export default function TestimonialCard({ quote, author, role, index = 0 }) {
  return (
    <motion.div
      ...
      className="glass-card p-5 sm:p-6 md:p-8 flex flex-col min-w-0"
    >
      <p className="text-gray-800 text-base sm:text-lg italic mb-6 flex-1 min-w-0 break-words">&ldquo;{quote}&rdquo;</p>
      <div>
